                ...
                <div style="border:0px solid red;width:910px;height:695px;display:flex;margin-left:50px; ">
                    <div style="display:flex">
                        <div style="border:0px solid green;width:900px;height:690px ">
                            <div style="border:0px solid pink;width:880px;height:100px;display:flex;">
                                <div  style="border:0px solid rgb(210, 243, 21);width:300px;">
                                    <img src="./images/lupy.jpg" alt="" style="width:30%;height:90%;margin:auto; display: block;border-radius:120px;">
                                </div>
                                <div style="border:0px solid rgb(210, 243, 21);width:300px;">
                                    ...
                                    <label>희망국가 </label>
                                        <table>
                                            <tr>
                                                ...
                                                <td><input type="checkbox" value="포르투칼">포르투칼</td>
                                            </tr>
                                            <tr>
