...
<!--                         <li><a href="">워홀러들 자주 하는 질문</a></li> -->
            ...
            <div id="reviewContainer">
                ...
                <div id="reviewImageContainer">
                    <div class="reviewImage">
                        ...
                        <div>
                            <a href="<%=request.getContextPath()%>/community/readReview.do?ReviewNo=84"> <img src="images/84.PNG" alt="" width="200px" height="300px"></a>
                        </div>
                    </div>
                    <div class="reviewImage">
                        <div class="profileImageContainer">
                        ...
                        <div>
                             <a href="<%=request.getContextPath()%>/community/readReview.do?ReviewNo=85"><img src="images/85.PNG" alt="" width="200px" height="300px"></a>
                        </div>
                    </div>
                    <div class="reviewImage">
                        <div class="profileImageContainer">
                        ...
                        <div>
                             <a href="<%=request.getContextPath()%>/community/readReview.do?ReviewNo=86"><img src="images/86.PNG" alt="" width="200px" height="300px"></a>
                        </div>
                    </div>
                    <div class="reviewImage">
                        <div class="profileImageContainer">
                        ...
                        <div>
                            <a href="<%=request.getContextPath()%>/community/readReview.do?ReviewNo=91"><img src="images/91.PNG" alt="" width="200px" height="300px"></a>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <!-- 카카오톡 공유하기 아이콘 스크립트 구문 -->
    ...
    content: {
      ...
      //추후에 사이트 주소로 수정하기
      link: {
        mobileWebUrl: 'http://gd1class.iptime.org:9999/GDJ56_smtw_semi/',
        webUrl: 'http://gd1class.iptime.org:9999/GDJ56_smtw_semi/',
      },
    },
    itemContent: {
      profileText: 'Show Me The Way',
      //show me the way 로고로 수정하기
      profileImageUrl: 'https://img.freepik.com/premium-vector/airplane-illustration_253396-216.jpg',
      titleImageUrl: 'https://vrthumb.imagetoday.co.kr/2018/08/22/tid050t003074.jpg',
