...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js"></script>
  ...
  <div class="sector">
        ...
        <div class="contentList">
            ...
            <div id="postmenu">
            	<div id="postrecieve"><center><h2 style="background-color: mediumpurple;font-size:24px;" onclick="location.replace('<%=request.getContextPath()%>/mypage/mypageNoteReceive.do?id=<%=logInMember.getMemberId()%>');">수신함</h2></center></div><br>
            	<div id="postsend"><center><h2 style="background-color: rgb(239, 239, 239);font-size:24px;" onclick="location.replace('<%=request.getContextPath()%>/mypage/mypageNoteSend.do?id=<%=logInMember.getMemberId()%>');">발신함</h2></center></div><br>
            </div>
