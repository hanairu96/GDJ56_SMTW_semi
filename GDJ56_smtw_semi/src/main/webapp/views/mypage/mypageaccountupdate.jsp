...
//                 var extraAddr = ''; // 참고항목 변수
            ...
            <div>비밀번호 : <button name="password" onclick="window.open('mypage-pwupdate.html','_blank','scrollbars=yes,width=500,height=385,top=100,left=100')">비밀번호변경</button></div>
           
           
            <div style="padding: 2%;"><input type="submit" name="저장하기" value="저장하기" style="float: right;" onclick=""></div>
