<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.smtw.member.model.vo.Member,com.smtw.qna.model.vo.Qna" %>
<%
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/qnaWrite.css"/>
	<section id="notice-container">
        <div>
            <form action="<%=request.getContextPath()%>/qna/modifyQnaEnd.do?qnaNo=<%=q.getQnaNo()%>" method="post" onsubmit="return fn_summernote();">
                <h2>Q&A 글쓰기</h2>
                <table id="tbl-notice">
                <tr>
                    <th>제 목</th>
                    <td>
                    	<input type="text" name="qnaTitle" placeholder="제목" size="65" required value="<%=q.getReviewTitle()%>">
                    </td>
                </tr>
                <tr>
                    <th>작성자</th>
                ...
                <tr>
                    <th colspan="2">
                        <div class="cont">
                            <textarea rows="10" cols="100" name="summernote" id="summernote" required><%=q.getReviewContents() %></textarea>
                        </div>
                    </th>
                </tr>
                </table>
