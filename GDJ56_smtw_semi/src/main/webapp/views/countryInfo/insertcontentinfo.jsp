    ...
    <div id="insertCountrypage">
        <fieldset>
            <legend><h1 style="text-align: centers;">국가 내용 입력 페이지</h1></legend>
                ...
                <div>
                    국가/지역소개
                    <br><textarea name="coareainfo" id="" cols="100" rows="30" placeholder="국가/지역소개 입력" required></textarea>
                </div>
                <br>    
                <div>
                    워홀비자 
                    <br><textarea name="wkvisa" id="" cols="100" rows="30" placeholder="워홀비자 입력" required></textarea>
                </div>
                <br>  
                <div>
                    안전정보 
                    <br><textarea name="safebady" id="" cols="100" rows="30" placeholder="안전정보 입력" required></textarea>
                </div>
                <br>  
                <div>
                    초기정착 
                    <br><textarea name="homestay" id="" cols="100" rows="30" placeholder="초기정착 입력" required></textarea>
                </div>
                <br>  
                <div>
                    취업정보 
                    <br><textarea name="getjob" id="" cols="100" rows="30" placeholder="취업정보 입력" required></textarea>
                </div>
                <br>  
			    <div id="twobu">
