...
/**
 * Servlet implementation class insertinsertContentServlet
 */
@WebServlet("/countryinfo/insertcontentinfo.do")
public class insertinsertContentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public insertinsertContentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String coarea=request.getParameter("coareainfo");
...
//		System.out.println(cc);
		int result=new CountryPageInfoService().insertContent(cc);
		
		String msg="",loc="";
		if(result>0) {
			msg="정보등록이 정상적으로 완료되었습니다.";
			loc="/countryinfo/searchAll.do?nName="+name;
		}else {
			msg="등록에 실패하였습니다. 다시 시도해주세요.";
			loc="/countryinfo/goInsertContext.do";
		}
